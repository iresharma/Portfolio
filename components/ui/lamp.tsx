...
export default function ContactSection() {
    const placeholders = [
        "Looking for a junior full stack engineer?",
        "Wanna build a product?",
        "Let me take care of your startup dream?",
        "Want beautiful websites like this one?",
        "Let's connect to build something together. ",
    ];
    return (
        <LampContainer>
            <motion.h1
            ...
            >
                Build Software <br/> the right way
            </motion.h1>
            <motion.h1
                initial={{opacity: 0.5, y: 100}}
                whileInView={{opacity: 1, y: 0}}
                ...
                className="mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-md font-medium tracking-tight text-transparent"
            >
                Get in touch with me for opportunities
            </motion.h1>
